...
# sphinx-quickstart on Thu Aug  1 14:35:12 2013.
#
...
pkgmeta = {}
pkgmeta_file = os.path.join(os.path.dirname(__file__), '..', '{{ cookiecutter.app_name }}', 'pkgmeta.py')
...
# documentation.
html_theme_options = {
    'github_fork': '{{ cookiecutter.github_username }}/{{ cookiecutter.repo_name }}',
    'index_logo': None,
}
